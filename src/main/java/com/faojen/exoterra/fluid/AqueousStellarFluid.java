...
public abstract class AqueousStellarFluid extends ForgeFlowingFluid {
	public static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(Registration.AQUEOUS_STELLAR,
			...
			.bucket(ExoTerraItems.AQUEOUS_STELLAR_BUCKET).block(() -> (LiquidBlock) Registration.AQUEOUS_STELLAR_BLOCK.get());

	private AqueousStellarFluid() {
		super(PROPERTIES);
	}

	public static class Source extends AqueousStellarFluid {
		public Source() {
			super();
		}
	...
	public static class Flowing extends AqueousStellarFluid {
		public Flowing() {
			super();
		}
